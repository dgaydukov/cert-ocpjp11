...
* [Azul Platform Prime](https://www.azul.com/downloads/#prime) - commercial JVM optimized for low-latency and high-throughput applications that require huge memory heaps, including famous C4GC (Continuously Concurrent Compacting Collector), and available only for Linux. So it's not JDK but only fully optimized JVM for low-latency systems.
